...
sot_historical_player_stats.to_csv(f'/Users/tylermartins/Documents/PitchSights/ps-betting/strategies/shots-on-target/data/raw/sot_player_stats_{league}_{season}.csv')
sot_historical_match_stats.to_csv(f'/Users/tylermartins/Documents/PitchSights/ps-betting/strategies/shots-on-target/data/raw/sot_match_stats_{league}_{season}.csv')
