# ingestion/odds/snapshot_bet.py
import argparse
from pathlib import Path
from ingestion.odds.the_odds_api import run_odds_snapshot

def parse_args():
    p = argparse.ArgumentParser(description="Snapshot BET-window odds (24–3h before KO)")
    ...
    p.add_argument("--cache-ttl", type=int, default=30*60)
