...
def parse_args():
    p = argparse.ArgumentParser(description="Snapshot OPENERS odds (96–168h before KO)")
    ...
    # include main + props by default; override with --markets if needed
    p.add_argument("--markets", default="h2h,spreads,totals,player_goal_scorer_anytime,player_shots_on_target")
    p.add_argument("--season", default=None)
    p.add_argument("--cache-ttl", type=int, default=6*60*60)  # 6h
